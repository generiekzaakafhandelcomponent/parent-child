...
class ParentChildServiceTest {
    ...
    @Test
    fun `should assign a PARENT relation to the parent document on the child document`() {
        ...
        verify(documentService).assignDocumentRelation(documentIdCaptor.capture(), relationCaptor.capture())
