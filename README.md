...
2. Rename the parent-child plugin package, module, and configuration to match your plugin
...
- [Parent Child Plugin](documentation/plugin.md) — reference implementation included in this template
